...
namespace MiniDoodles
{
    ...
    /// </summary>
    public class MD_SoundManager : MD_Singlton<MD_SoundManager>
    {
        ...
        {
            bgm.volume = MD_ProgramManager.Instance.soundVolume.volume_BGM;
            effect.volume = MD_ProgramManager.Instance.soundVolume.volume_Effect;
        }
        ...
        {
            LoadAllAudioClipFromPath(MD_PathDefine.Audio_BGMPath);
            LoadAllAudioClipFromPath(MD_PathDefine.Audio_EffectPath);
        }
